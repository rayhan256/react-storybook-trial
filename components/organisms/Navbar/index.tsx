...
export default function index(props: NavbarProps) {
  const { isHome, isGame, isReward, isDiscover, isGlobalRank } = props
          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto text-lg gap-lg-0 gap-2">
                <Menu title="Home" isActive={isHome} />
                <Menu title="Games" isActive={isGame} />
                <Menu title="Rewards" isActive={isReward} />
                <Menu title="Discover" isActive={isDiscover} />
                <Menu title="Global Rank" isActive={isGlobalRank} />
                <Menu title="Sign In" isActive={false} isButton={true} />
              </ul>
            </div>
          </div>
        </nav>
